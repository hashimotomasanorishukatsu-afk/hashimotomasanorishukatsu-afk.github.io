...
研究の方針決定や実装ではAIエージェントも活用している。ただし、AIに答えを出してもらうのではなく、自分だけでは得られなかった情報を増やせるかを基準に使っている。
...
重要な判断は、まず自分の実装を測定し、その結果をもとに行う。AIには自身の仮説を批判的思考で分析させたり、自分では見落としていた前提を発見したりする役割を担わせている。
