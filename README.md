...
下の図は、本研究が実際に扱っている橋（今回の実験に使っている2パネル分・全長26mのモデル、部材53本）を、実際の座標データからそのまま描き起こしたもの。色は部材の種類ごとに分けてある。丸で囲んだ場所のように、何本もの部材が1点に集まる「接合部」が何箇所もあり、ここが本研究で最も撮影が難しい場所になる。

![本研究が扱う橋梁トラス構造の等角投影図。53本の部材が下弦材・上弦材・垂直材・斜材・横桁・縦桁リブ・道路床版・水平ブレースの8種類に色分けされ、複数の部材が集まる接合部が赤丸で示されている。](diagram-bridge-structure.svg)
